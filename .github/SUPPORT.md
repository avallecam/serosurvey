# Getting help with serosurvey

Thanks for using serosurvey. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/serosurvey/issues) to make sure the 
